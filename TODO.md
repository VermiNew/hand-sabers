...
- [x] Obniżyć koszt renderowania aktywnych kostek bez usuwania obrysu, strzałek, odbić ani mechaniki — korpusy używają lżejszego materiału Phong, elementy poza kadrem są odrzucane, sześć kolców bomby stanowi jedną geometrię, a korpusy, obrysy, strzałki i ogony held notes są instancjonowane. Kontrolowany render obniżył koszt 12 zwykłych nut z 36 do 5 draw calli (około 86%), a 12 held notes z 48 do 7, przy zachowanych kolorach, kierunkach i długościach; wcześniejszy benchmark materiału 30 kostek obniżył średni czas renderu z 6,27 ms do 4,40 ms. Rzeczywisty FPS pozostaje zależny od GPU i wymaga potwierdzenia na docelowym komputerze.
