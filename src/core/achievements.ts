...
const ACHIEVEMENTS: AchievementDef[] = [
  ...
  defineAchievement('hundred_games', 'stadia_controller', 'gameplay', 'gold', 100, s => s.totalGames),
  ...
  defineAchievement('ten_thousand_hits', 'swords', 'gameplay', 'diamond', 10_000, s => s.totalHits),
  ...
  defineAchievement('combo_1000', 'electric_bolt', 'gameplay', 'diamond', 1000, s => s.maxCombo),
  ...
  defineAchievement('fifty_wins', 'crown', 'gameplay', 'gold', 50, s => s.gamesWon),
  ...
  defineAchievement('no_miss_25', 'shield', 'gameplay', 'diamond', 25, s => s.noMissGames),
  ...
  defineAchievement('maps_25', 'travel_explore', 'gameplay', 'gold', 25, s => s.mapsCompleted),
  ...
  defineAchievement('play_25h', 'pace', 'gameplay', 'diamond', 90_000_000, s => s.totalPlayTimeMs),
  ...
  defineAchievement('score_5m', 'rocket_launch', 'gameplay', 'diamond', 5_000_000, s => s.totalScore),
  ...
  defineAchievement('mp_fifty_games', 'diversity_3', 'multiplayer', 'gold', 50, s => s.multiplayerGamesPlayed),
  defineAchievement('mp_first_win', 'emoji_events', 'multiplayer', 'silver', 1, s => s.multiplayerWins),
  defineAchievement('mp_twenty_five_wins', 'social_leaderboard', 'multiplayer', 'diamond', 25, s => s.multiplayerWins),
  defineAchievement('mp_coop_master', 'handshake', 'multiplayer', 'gold', 5, s => s.coopWins),
  defineAchievement('mp_coop_legend', 'group_work', 'multiplayer', 'diamond', 20, s => s.coopWins),
  ...
  defineAchievement('creator_visionary', 'architecture', 'creator', 'diamond', 50, s => s.mapsCreated),
  ...
  defineAchievement('social_perfectionist', 'auto_awesome', 'social', 'diamond', 10, s => s.perfectGames),
];
